...
import ResourceNodeLinkFactory from './ResourceNodeLinkFactory'

export default class ResourceNodeLinkModel extends DefaultLinkModel {
	constructor(options = {}) {
		super({
			type: ResourceNodeLinkFactory.NAME,
			...options,
		})
